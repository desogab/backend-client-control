...
exports.saveProfessional = function (professional) {
  return db.one(
    'with new_user as (insert into professional_user(username, password)values($1, $2)returning *) insert into professional_info(name, surname, birthdate, cpf, email, phone, profession, professional_document, user_id) values ($3, $4, $5, $6, $7, $8, $9, $10,(select id from new_user)) returning *',
    [
